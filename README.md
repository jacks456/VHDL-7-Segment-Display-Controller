...
**Background**
Interfacing binary hardware with human-readable displays requires efficient decoding logic. This project implements a combinational logic decoder that converts 4-bit binary inputs into the signals required to drive a physical 7-segment display.
